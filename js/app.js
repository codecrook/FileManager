(function() {
    ...
    function createNewFile(e) {
        ...
        download('\0', fileName, fileExtension);
    ...
    /*function to create a file and download it to local system
     *code copied from stackoverflow
     */
    function download(data, filename, type) {
        var file = new Blob([data], {type: type}); // creates file using BLOB
        if (window.navigator.msSaveOrOpenBlob) {
            ...
            //removes the link created for download immidiately
            setTimeout(function() {
